                  ...
                  if(snapshot.connectionState == ConnectionState.waiting){
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context,int index){
                        ...
                        return  Container(
                            margin: EdgeInsets.fromLTRB(0.03*width, 0, 0.01*width, 0.01*height),
                            padding: EdgeInsets.fromLTRB(0,0,0,0.01*height),
                            decoration: const BoxDecoration(
                              border: Border(
                                bottom: BorderSide(
                            ...
                            child: SizedBox(
                                child: Stack(
                                  ...
                                  children: [
                                    Container(
                                        margin: EdgeInsets.fromLTRB(0.05*width,0, 0.0*width, 0),
                                        child: Row(
                                          children: [
                                            ret!=-1?
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                  ...
                                                  children : [
                                                    ret==-1?
                                                    Text(
                                                        phno == snapshot.data!.docs.elementAt(index)["memberNumber"]? 'Myself' : snapshot.data!.docs.elementAt(index)["memberNumber"]
                                                    ...
                                                    snapshot.data!.docs.elementAt(index)["status"]== 'Accepted'? const SizedBox():
                                                    // mem[index]['status'] == 'Accepted'? const SizedBox():
                                                    // mem[index]['mapValue']['fields']['status']['stringValue'] == 'Accepted'?const SizedBox():
                                                    Container(
                                                      margin: EdgeInsets.fromLTRB(0,5*height/740,0,0),
                                                      child: Text(
                                    ...
                                    Align(
                                      alignment: Alignment.centerRight,
                                      child: Container(
                                          margin: EdgeInsets.fromLTRB(0, 0, 0*width/360, 0),
                                          child: TextButton(
                                            onPressed: (){
                                              CenterList.per = ret;
                                              CenterList.mem = snapshot.data!.docs.elementAt(index);
                                              print(CenterList.mem['memberNumber']);
...
class LovedOneHolder extends StatefulWidget {
  const LovedOneHolder({Key? key}) : super(key: key);

  @override
  State<LovedOneHolder> createState() => _LovedOneHolderState();
}

class _LovedOneHolderState extends State<LovedOneHolder> {
  @override
  String loved_one_num = '';
  dynamic loved_one;
  @override
